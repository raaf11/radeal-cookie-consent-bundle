...
class Configuration implements ConfigurationInterface
{
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        if (method_exists($treeBuilder, 'getRootNode')) {
            ...
            $rootNode = /* @scrutinizer ignore-deprecated */
                $treeBuilder->root('ch_cookie_consent');
        }

        $rootNode
            ->children()
            ->variableNode('categories')
            ->defaultValue([CategoryEnum::CATEGORY_ANALYTICS, CategoryEnum::CATEGORY_TRACKING, CategoryEnum::CATEGORY_MARKETING, CategoryEnum::CATEGORY_SOCIAL_MEDIA])
            ->end()
